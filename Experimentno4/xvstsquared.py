...
for sheet in sheets:
    ...
    plt.xlabel('Time² (s²)')
    plt.ylabel('X(cm)')
    plt.title(f"linear Fit for Distance vs t² at 10° and 15° Slopes {sheet} Set")
    plt.legend(["Data at 10°", f'Linear Fit={eq1}',"Data at 15°", f'Linear Fit={eq2}'], loc='best', facecolor='w')
    plt.show()